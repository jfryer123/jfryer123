...
const $closeBtn = $('#close');
    ...
    const render = () => {
        ...
        // const rate = () => {
        // var promptAnswer = prompt("Did you like the book?", "yes or no");
        //   if(promptAnswer == "yes") {
        //     $($items).append($(".like").show())
        //   } else {
        //     $(".dislike").show()
        //   }
...
///////////////////////this works /////////////////////////
    ...
    $('.readingList').on('click', (event)=>{
      ...
      var promptAnswer = prompt("Did you like the book?", "yes or no");
        if(promptAnswer == "yes") {
          $(event.target).parent($(".like").show())
        } else {
          $(".dislike").show()
        }
      });
        // } if else {
        //   $(event.target).parent().append("<button>").text("Don't recommend to friends");
        // }
